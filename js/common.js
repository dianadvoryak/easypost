...
let getMenu1 = document.querySelector('.menu1')
let getBurgerMenu1 = document.querySelector('.burger_menu1')

function Rotate1(click){
    getBurgerMenu1.classList.toggle('rotate')
		getMenu1.classList.toggle('active')
		getBody.classList.toggle('hidden')
}
